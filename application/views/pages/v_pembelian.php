...
<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <td>
            ...
            <a class="btn btn-mini" href="<?php echo site_url('Pembelian/hapus_barang/'.$row->kd_mobil);?>"
...
if (isset($data_barang)){
    foreach($data_barang as $row){
        ...
        <div id="modalEditBarang<?php echo $row->kd_mobil?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h3 id="myModalLabel">Edit Data Mobil</h3>
            </div>
            <form class="form-horizontal" method="post" action="<?php echo site_url('Pembelian/edit_barang')?>">
                <div class="modal-body">
                    ...
                    <div class="control-group">
                        <label class="control-label" >Tahun</label>
                        <div class="controls">
                            <input name="Tahun" type="text" value="<?php echo $row->Tahun;?>" >
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        <label class="control-label" >Warna</label>
                        <div class="controls">
                            <input name="Warna" type="text" value="<?php echo $row->Warna;?>" >
                        </div>
                    </div>
                     ...
                     <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="Km" type="text" value="<?php echo $row->Km;?>">
                        </div>
                    </div>
